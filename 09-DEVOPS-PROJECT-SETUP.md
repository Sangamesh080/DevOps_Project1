...
```     
  git credentialsId: 'GIT-Credentials', url: 'https://github.com/Sangamesh080/maven-web-app.git'
```
...
```
stage ('Nexus Upload'){
nexusArtifactUploader artifacts: [[artifactId: '01-Maven-Web-App', classifier: '', file: 'target/01-maven-web-app.war', type: 'war']], credentialsId: 'Nexus-Credentials', groupId: 'in.sangameshit', nexusUrl: '13.127.185.241:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'sangameshit-snapshot-repository', version: '1.0-SNAPSHOT'
}
```
